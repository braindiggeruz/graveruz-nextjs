...
const products = [
  {
    ...
    image: '/images/products/lighters/r109_silver_gloss.webp',
  ...
  },
  {
    ...
    image: '/images/products/lighters/r110_black_matte.webp',
  ...
  },
  {
    ...
    image: '/images/products/lighters/r112_brushed_steel.webp',
...
export default function LightersLanding({ locale }: Props) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-16 bg-black" data-testid="lighters-reviews">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                nameRu: 'Александр К.',
                nameUz: 'Aleksandr K.',
                roleRu: 'HR-директор, IT-компания',
                roleUz: 'HR-direktor, IT-kompaniya',
                textRu: 'Заказали 50 зажигалок с логотипом для welcome-пака. Макет согласовали за день, срок выдержали. Сотрудники довольны.',
                textUz: "50 ta zajigalka buyurtma qildik welcome-pak uchun. Maketni bir kunda kelishib oldik, muddatga rioya qilindi. Xodimlar mamnun.",
              },
              {
                nameRu: 'Мадина Р.',
                nameUz: 'Madina R.',
                roleRu: 'Менеджер по маркетингу',
                roleUz: 'Marketing menejeri',
                textRu: 'Подарок партнёру — зажигалка R-112 с гравировкой логотипа. Выглядит премиально, партнёр оценил. Будем заказывать ещё.',
                textUz: "Hamkorga sovg'a — logotip gravyurali R-112 zajigalka. Ko'rinishi premium, hamkor mamnun. Yana buyurtma beramiz.",
              },
              {
                nameRu: 'Даврон Т.',
                nameUz: 'Davron T.',
                ...
                roleUz: 'Biznes egasi',
                textRu: 'Брал зажигалку R-110 с инициалами в подарок. Гравировка чёткая, выглядит дорого. Макет прислали быстро.',
                textUz: "Ukamga R-110 zajigalka initsiallar bilan sovg'a qildim. Gravyura aniq, ko'rinishi qimmatbaho. Maketni tez yuborganlar.",
              },
            ].map((r, i) => (
