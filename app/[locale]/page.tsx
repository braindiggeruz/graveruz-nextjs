...
export default async function HomePage({ params }: PageProps) {
  ...
  const portfolioList = cmsPortfolio.length > 0
    ...
    : [
        { img: '/images/products/neo/neo-watch-black-gold.jpg', category: isRu ? 'Награды и признание' : 'Mukofotlar va tan olish', title: isRu ? 'Корпоративные награды' : 'Korporativ mukofotlar', desc: isRu ? 'Премиальные награды с гравировкой для сотрудников и партнёров' : 'Xodimlar va hamkorlar uchun gravyurali premium mukofotlar', material: isRu ? 'Металл, дерево' : "Metall, yog'och", application: isRu ? 'Награждение персонала' : 'Xodimlarni mukofotlash' },
        { img: '/images/products/neo/neo-watch-white-gold.jpg', category: isRu ? 'Премиальные подарки' : "Premium sovg'alar", title: isRu ? 'Часы с персональной гравировкой' : 'Shaxsiy gravyurali soatlar', desc: isRu ? 'Элитные часы с индивидуальной гравировкой для топ-менеджмента' : 'Top-menejerlar uchun individual gravyurali elit soatlar', material: isRu ? 'Металл, стекло' : 'Metall, shisha', application: isRu ? 'Подарки руководителям' : "Rahbarlarga sovg'alar" },
        { img: '/images/products/neo/neo-watch-black-silver.jpg', category: isRu ? 'Корпоративная продукция' : 'Korporativ mahsulotlar', title: isRu ? 'Брендированные термосы' : 'Brendlangan termoslar', desc: isRu ? 'Качественные термосы с логотипом компании для команды' : 'Jamoa uchun kompaniya logotipi bilan sifatli termoslar', material: isRu ? 'Анодированный алюминий' : 'Anodlangan alyuminiy', application: isRu ? 'Подарки сотрудникам' : "Xodimlarga sovg'alar" },
      ]
