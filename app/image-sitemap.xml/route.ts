...
const STATIC_ENTRIES: {
  ...
  },
  {
    ...
    images: [
      ...
      { url: '/images/products/neo-watch-hero.webp', title: 'NEO Watch Hero — часы с гравировкой' },
      { url: '/images/products/neo-watch-automatic.webp', title: 'NEO Watch Automatic — автоматические часы с гравировкой' },
      { url: '/images/products/neo-watch-quartz.webp', title: 'NEO Watch Quartz — кварцевые часы с гравировкой' },
  ...
  },
  {
    ...
    images: [
      ...
      { url: '/images/products/lighters/r109_silver_gloss.webp', title: 'Зажигалка R109 Silver Gloss с гравировкой' },
      { url: '/images/products/lighters/r110_black_matte.webp', title: 'Зажигалка R110 Black Matte с гравировкой' },
      { url: '/images/products/lighters/r111_black_texture.jpg', title: 'Зажигалка R111 Black Texture с гравировкой' },
      { url: '/images/products/lighters/r112_brushed_steel.webp', title: 'Зажигалка R112 Brushed Steel с гравировкой' },
    ],
  },
  {
